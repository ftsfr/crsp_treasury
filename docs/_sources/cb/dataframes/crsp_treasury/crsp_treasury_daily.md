...
Rows: 2530592
Columns: 29
$ kytreasno                  <f64> 200675.0
$ kycrspid                   <str> '19700815.104000'
$ tcusip                     <str> '912810AG'
$ caldt             <datetime[ns]> 1970-01-02 00:00:00
$ tdatdt            <datetime[ns]> 1963-06-20 00:00:00
$ tmatdt            <datetime[ns]> 1970-08-15 00:00:00
$ tfcaldt           <datetime[ns]> 1970-01-01 00:00:00
$ tdbid                      <f64> 97.34375
$ tdask                      <f64> 97.46875
$ tdaccint                   <f64> 1.5217391304348
$ tdyld                      <f64> 0.0002257801889589
$ tdpubout                   <f64> 3667.0
$ tdtotout                   <f64> 4129.0
$ tdpdint                    <f64> 0.0
$ tcouprt                    <f64> 4.0
...
$ tdduratn                   <f64> 221.37694468124
$ tdretnua                   <f64> 0.00085224539168923
$ days_to_maturity           <i64> 225
$ callable                  <bool> False
$ price_dirty                <f64> 98.9279891304348
$ run                        <i64> 0
$ auction_term               <str> null
$ auction_type               <str> null
$ gsw_price_dirty            <f64> null
$ gsw_price_clean            <f64> null
$ gsw_ytm                    <f64> null
...
| Data Sources                   | crsp, treasury_auction_stats, fed_yield_curve                                        |
| Data Providers                 | WRDS, TreasuryDirect, Federal Reserve                                      |
| Links to Providers             |                              |
| Topic Tags                     | Treasuries                                          |
| Type of Data Access            | WRDS,Web API,Federal Reserve CSV                                  |
| How is data pulled?            | CRSP via WRDS API, runness from TreasuryDirect auction data merged by CUSIP and date, GSW model-implied prices from Fed Svensson parameters                                                    |
