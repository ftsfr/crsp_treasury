...
$ accruedInterestPer100                                       <f64> null
$ adjustedAccruedInterestPer1000                              <f64> null
$ adjustedPrice                                               <f64> null
$ allocationPercentage                                        <f64> 99.0
$ allocationPercentageDecimals                                <str> '0'
$ announcedCusip                                              <str> ''
$ auctionFormat                                               <str> 'Multi-Price'
$ averageMedianDiscountRate                                   <f64> null
$ averageMedianInvestmentRate                                 <f64> null
$ averageMedianPrice                                          <f64> 100.0
$ averageMedianDiscountMargin                                 <str> ''
$ averageMedianYield                                          <str> '10.750000'
$ backDated                                                  <null> null
$ backDatedDate                                      <datetime[ns]> null
$ bidToCoverRatio                                             <f64> null
$ callDate                                           <datetime[ns]> null
$ callable                                                   <null> null
$ calledDate                                         <datetime[ns]> null
$ cashManagementBillCMB                                      <null> null
...
$ originalCusip                                               <str> ''
$ originalDatedDate                                  <datetime[ns]> null
$ originalIssueDate                                  <datetime[ns]> null
...
$ somaAccepted                                                <str> ''
$ somaHoldings                                                <str> ''
$ somaIncluded                                               <null> null
$ somaTendered                                                <str> ''
$ spread                                                      <str> ''
$ standardInterestPaymentPer1000                              <str> '53.7500'
$ strippable                                                 <null> null
$ term                                                        <str> '10-Year'
...
$ tintCusip1                                                  <str> ''
$ tintCusip2                                                  <str> ''
$ tintCusip1DueDate                                  <datetime[ns]> null
$ tintCusip2DueDate                                  <datetime[ns]> null
$ run                                                         <i64> 0
$ runness_term                                                <str> null
$ runness_type                                                <str> null
...
| Data available up to (max)     | 2026-02-18 00:00:00                                                             |
